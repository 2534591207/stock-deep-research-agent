...
技术栈：Python + FastAPI 后端 · Vite + React + TypeScript 前端 · LangGraph/OpenAI（理解/叙述）· pandas/numpy（确定性指标）· 行情 Yahoo Finance。
...
├── .harness/                     # 工程约束体系 + 设计文档（见下）
│   └── changes/phase-1-mvp/      # 设计文档：PRD.md · backend/(spec.md · plan.md · tasks.md) · api-integration.md
├── AGENTS.md  README.md          # 指引与入口
└── .env.example                  # 环境变量模板
```
